...
axis square
title(['Transition phases recognition'], 'fontname', 'times', 'fontsize', 16);
set(gca, 'xticklabel', '', 'yticklabel', '', 'fontname', 'times', 'fontsize', 13)

% x axis
text(0.85, 3.59, 'phase 1', 'color', 'k', 'fontname', 'times', 'fontsize', 13);
text(1.81, 3.59, 'phase 2', 'color', 'k', 'fontname', 'times', 'fontsize', 13);
text(2.80, 3.59, 'phase 3', 'color', 'k', 'fontname', 'times', 'fontsize', 13);
text(1.59, 3.77, 'predicted phase', 'color', 'k', 'fontname', 'times', 'fontsize', 13);

% y axis
text(0.37, 1.15, 'phase 1', 'color', 'k', 'fontname', 'times', 'fontsize', 13, 'rotation',90);
text(0.37, 2.2, 'phase 2', 'color', 'k', 'fontname', 'times', 'fontsize', 13, 'rotation',90);
text(0.37, 3.15, 'phase 3', 'color', 'k', 'fontname', 'times', 'fontsize', 13, 'rotation',90);
text(0.16, 2.3, 'actual phase', 'color', 'k', 'fontname', 'times', 'fontsize', 13, 'rotation',90);

for i=1:size(stMat,1)
    for j=1:size(stMat,2)
        if( stMat(j,i) <= 50 )
            if( stMat(j,i) == 0 )
                text(i-0.05, j, [num2str(stMat(j,i),3) '%'], 'Color', 'k', 'FontName', 'times', 'FontSize', 12)
            else
                text(i-0.15, j, [num2str(stMat(j,i),3) '%'], 'Color', 'k', 'FontName', 'times', 'FontSize', 12)
            end
        else
            if( stMat(j,i) == 0 )
                text(i-0.05, j, [num2str(stMat(j,i),3) '%'], 'Color', 'w', 'FontName', 'times', 'FontSize', 12)
            else
                text(i-0.15, j, [num2str(stMat(j,i),3) '%'], 'Color', 'w', 'FontName', 'times', 'FontSize', 12)
            end
        end
    end
end
