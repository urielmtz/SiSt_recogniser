...
axis square
title(['Transition phases recognition'], 'fontname', 'times', 'fontsize', 14);
set(gca, 'xticklabel', '', 'yticklabel', '', 'fontname', 'times', 'fontsize', 12)

% x axis
text(0.85, 2.56, 'phase 1', 'color', 'k', 'fontname', 'times', 'fontsize', 12);
text(1.88, 2.56, 'phase 2', 'color', 'k', 'fontname', 'times', 'fontsize', 12);
text(1.20, 2.67, 'predicted phase', 'color', 'k', 'fontname', 'times', 'fontsize', 12);

% y axis
text(0.40, 1.12, 'phase 1', 'color', 'k', 'fontname', 'times', 'fontsize', 12, 'rotation',90);
text(0.40, 2.1, 'phase 2', 'color', 'k', 'fontname', 'times', 'fontsize', 12, 'rotation',90);
text(0.25, 1.7, 'actual phase', 'color', 'k', 'fontname', 'times', 'fontsize', 12, 'rotation',90);
    ...
    for j=1:size(stMat,2)
        if( stMat(j,i) <= 50 )
            if( stMat(j,i) == 0 )
                ...
                text(i-0.10, j, [num2str(stMat(j,i),3) '%'], 'Color', 'k', 'FontName', 'times', 'FontSize', 12)
            end
        else
            if( stMat(j,i) == 0 )
                text(i-0.05, j, [num2str(stMat(j,i),3) '%'], 'Color', 'w', 'FontName', 'times', 'FontSize', 12)
            else
                text(i-0.10, j, [num2str(stMat(j,i),3) '%'], 'Color', 'w', 'FontName', 'times', 'FontSize', 12)
            end
        end
    end
end
